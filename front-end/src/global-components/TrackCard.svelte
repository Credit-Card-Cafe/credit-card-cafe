...
{#if localUser}
    <div class="flex flex-row my-6 justify-center z-20">
        {#if show == "both"}
            <button on:click={() => addCardtoUser(Fields.Wallet)} class="btn mr-1 bg-sky-500 hover:bg-sky-600"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4 inline">
                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
              </svg>
              Add to Wallet</button>
            <button on:click={() => addCardtoUser(Fields.Tracking)} class="btn ml-1 bg-sky-500 hover:bg-sky-600"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4 inline">

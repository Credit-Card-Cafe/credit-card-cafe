...
const lists = {
  rewardCategories: {
    ...
    // if the credit card has custom options, add 'custom': 0 to the rewards object
    grocery: "Grocery",
    ...
    gas: "Gas Station",
    //exclusively gas stations 
    ev: "Electric Vehicle Charging",
    //exclusively EV charging stations 
    ...
    // "everything else" ,"other purchases" etc... 
    drug: "Drug Store",
    self: "Through Card's Company",
    // Mostly for store cards 
    high_spend: "Highest spend",
    //Highest spend category over a given period 
    rotating: "Rotating Category",
    //Categories of rewards rotate every given period 
    wholesale: "Wholesale Club",
    //Costco, Sams Club, BJs etc..
    superstore: "Superstore",
    //Target + Walmart, but not wholesale 
    entertainment: "Entertainment"
    //Movies, Theater, Streaming included 
  }
};
export {
  cardFieldNames as c,

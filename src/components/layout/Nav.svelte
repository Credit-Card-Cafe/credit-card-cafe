...
<div class={`fixed z-40 w-full flex flex-col justify-between md:flex-row md:items-center md:justify-items-center md:py-4 md:px-2 lg:px-8 py-2 backdrop-blur-md md:bg-alt/[0.8] md:dark:bg-main-gray ${(showMobileMenu || windowWidth >= 768) ? "bg-green-300 dark:bg-green-900" : "bg-alt/[0.8] dark:bg-main-gray"}`}>
    ...
    <a on:click={() => closeMenu()} href="/" class="hidden md:inline lg:mx-8 float-right text-green-500 font-semibold">CreditCardDB</a>
    ...
    <SearchBar></SearchBar>
    <hr class="md:hidden w-11/12 mx-auto my-2">
    <div id="end" class="flex flex-col md:flex-row flex-1 justify-end">

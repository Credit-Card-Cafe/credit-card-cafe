...
<!-- Footer -->
<div id="footer" class="w-full md:p-10 bg-alt/90 dark:bg-main-gray flex flex-col items-center">
    <div class="block lg:mr-8 text-green-500 font-semibold">CreditCardDB</div>
    <div class="dark:text-white-warm md:pt-16 md:ml-12 px-4  md:px-8">
        <div class="font-bold">Disclosure:</div>
        <div>- CreditCardDB has no relation to any Bank, Brand, or Credit Card listed on this website.</div>
    ...
    <div class="p-8 dark:text-white-warm">Developed by Ben Keil, 2024 - please visit <a href="http://benkeil.com">benkeil.com</a></div>  

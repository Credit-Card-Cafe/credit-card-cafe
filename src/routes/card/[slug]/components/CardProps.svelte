...
<div class="mb-4 rounded-md p-4 lg:p-6">
    ...
    {/if}
    {#if card.brand}<div class="flex flex-row items-center group/brand">
    ...
    <div class="flex flex-row items-center group/bank">
        ...
        <a href="/bank/{card.bank_url}">{card.bank_name}</a>
